...
export const screens: Screen[] = [
    ...
    { name: "02-category-search.png", label: "Category search", desc: "Intuitive navigation by concern or product type" },
