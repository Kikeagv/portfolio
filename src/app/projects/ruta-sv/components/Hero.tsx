...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-linear-to-br from-[#0047AB]/40 via-[#0a0a0a] to-[#00A86B]/20" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
        <motion.p
          ...
          className="mb-6 text-sm tracking-[0.3em] text-[#4D8FD6] uppercase"
        >
          Case Study
        </motion.p>
        ...
        >
          Designing transit for
          <br />
          <span className="text-[#4D8FD6] italic">everyone</span>
          <br />
          in El Salvador
        </motion.h1>
